/* 문항 에디터 화면 — AICoverPage.tsx에서 그대로 분리(2026-07-29). 렌더·동작 동일. */
import { useEffect, useRef, useState } from "react";
import { Link } from "react-router-dom";
import {
  ArrowLeft, ArrowLeftRight, ArrowRight, Check, Maximize2, Minimize2, MoreHorizontal,
...
import { KeywordChip } from "@/components/ds/KeywordChip";
import { EXPERIENCES, type Job } from "../model/aiCoverMock";
import { findSpellIssues, type SpellIssue } from "../model/spellRules";
import { essayCache } from "../model/essayCache";
import { QuestionPager } from "./QuestionPager";
import { PanelSection, ZoomView, TruncText } from "./PanelParts";
import { ExpCard, AddExperienceNotice } from "./ExpCard";
import { PipelineView, PIPELINE_NODES } from "./PipelineView";
...
export function EssayEditor({ job, onBack }: { job: Job; onBack: () => void }) {
