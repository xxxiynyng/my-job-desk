      ...
      <DialogContent className="max-w-sm">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-sm">
            ...
            {!editing && <button onClick={() => { setTitle(schedule.title); setEditing(true); }} aria-label="제목 편집" className="text-muted-foreground hover:text-foreground"><Pencil size={13} /></button>}
          </DialogTitle>
        </DialogHeader>
      ...
      <DialogContent className="max-w-sm">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-sm">
            ...
            {!editing && <button onClick={() => { setTitle(task.title); setEditing(true); }} aria-label="제목 편집" className="text-muted-foreground hover:text-foreground"><Pencil size={13} /></button>}
          </DialogTitle>
        </DialogHeader>
        <div className="space-y-2 text-sm">
