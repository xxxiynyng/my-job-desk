...
import { ExportModal } from "@/features/experiences/components/ExportModal";
...
export default function Experiences() {
  ...
  const { setSelectFilter, setTextFilter } = makeColFilterSetters(setColFilter);
  ...
  const { toggleColSort, setSortDirect } = makeColSortSetters(setSortMode, setColSort);
