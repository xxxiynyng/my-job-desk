            ...
            <div className="flex-1 min-w-0 space-y-7">
              {visibleGroups.length === 0 ? (
                ...
                visibleGroups.map((group) => (
                  <div key={group.title}>
                    <h3 className="text-[11px] font-medium text-muted-foreground uppercase tracking-wide mb-2.5">
                      {group.title}
                    </h3>
                    <div className={cn(
                      "grid gap-x-10",
                      ...
                      {group.fields.map((f) => {
                        ...
                        return (
                          <div key={f.key} className="group flex items-center gap-3 py-1.5 border-b border-border/30">
                            {/* 레이블 */}
                            <span className="text-[11px] text-muted-foreground w-[88px] shrink-0 leading-none">
                              {f.label}
                            </span>
                            ...
                            <div className="flex-1 min-w-0 flex items-center gap-1.5">
                              {isMasked ? (
                                <span className="text-[12.5px] text-muted-foreground/30 tracking-widest select-none">
                                  ••••••
                                </span>
                              ) : (
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <button
                                      ...
                                      className="inline-flex items-center gap-1 text-[12.5px] text-foreground hover:text-primary transition-colors min-w-0 max-w-full text-left"
                                    >
