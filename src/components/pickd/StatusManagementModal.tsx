      ...
      >
        ...
        <div className="px-6 py-3.5 border-b border-border flex items-start justify-between">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 text-chip text-muted-foreground mb-1.5">
              <span>지원 대시보드</span>
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-80px)] px-6 py-5 space-y-6 bg-muted/20">
            ...
            action={
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="inline-flex items-center gap-1 text-chip text-muted-foreground hover:text-foreground px-1.5 py-0.5 rounded hover:bg-muted">
          ...
          >
            <div className="bg-card border border-border rounded-lg overflow-hidden">
              <table className="w-full text-xs">
                <thead>
                  <tr className="text-mini text-muted-foreground bg-muted/30 border-b border-border">
                ...
                <tbody>
                    ...
                    <tr key={it.id} className="border-b border-border/50 last:border-0 group hover:bg-muted/30">
                      ...
                      <td className="px-3 py-1.5">
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <button
                              className={cn("px-1.5 py-0.5 rounded text-mini font-medium", STATUS_BADGE[it.status])}
                            >
                              {it.status}
                            </button>
                          </DropdownMenuTrigger>
                  ...
                  {items.length === 0 && (
                    <tr>
                      <td colSpan={5} className="px-3 py-6 text-center text-chip text-muted-foreground">
                        연결된 일정·할 일이 없습니다.
                      </td>
                    </tr>
                  )}
          ...
          <Section title="메모">
            <textarea
              ...
              className="w-full bg-card border border-border rounded-lg px-3 py-2.5 text-body text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring resize-none"
              rows={3}
            />
          </Section>
        </div>
